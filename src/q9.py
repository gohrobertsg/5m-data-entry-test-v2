...
and which command moves a file from there into the next commit?
    ...
    Answer: Git tells me that Git sees changes in a file that i edited in the working directory that has not been added to staging area for next commit.
    The command that move a file is : git add <file>
"""
